...
async function handler(req, res) {
    ...
    const rl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$rateLimit$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["rateLimit"])(String(ip) + ':register', 5, 60_000);
    ...
    const parsed = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$validate$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["registerSchema"].safeParse(input);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["info"])('register request', {
        cid,
        email,
        ip
    });
    try {
        ...
        if (exists) {
            db.close();
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$http$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["sendError"])(res, 409, 'User already exists');
        }
        // store hashed password using existing runtime hashing strategy
        const { hashPassword } = __turbopack_context__.r("[project]/pages/api/auth/utils.ts [api] (ecmascript)");
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["error"])('register error', {
            cid,
            message: err?.message || String(err)
        });
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$http$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["sendError"])(res, 500, err?.message || 'internal error');
    }
}
__turbopack_async_result__();
} catch(e) { __turbopack_async_result__(e); } }, false);}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0p6h4y_._.js.map