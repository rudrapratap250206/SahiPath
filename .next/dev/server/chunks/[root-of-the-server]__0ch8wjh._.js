...
"[project]/pages/api/media.ts [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    ...
    if (req.method !== 'POST') return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$http$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["sendError"])(res, 405, 'Method not allowed');
    const ip = req.headers['x-forwarded-for'] || req.socket.remoteAddress || 'ip';
    const rl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$rateLimit$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["rateLimit"])(String(ip) + ':media', 10, 60_000);
    ...
    const parsed = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$validate$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["mediaSchema"].safeParse(input);
    ...
    try {
        ...
        if (!match) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$http$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["sendError"])(res, 401, 'Not authenticated');
        ...
        if (!payload) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$http$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["sendError"])(res, 401, 'Invalid token');
        const { type, prompt } = parsed.data;
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["info"])('media request', {
            cid,
            type,
            user: payload.id,
            ip
        ...
        if (!OPENAI_KEY) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$http$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["sendError"])(res, 503, 'Media generation is not configured');
        }
        if (type === 'image') {
            ...
            if (!imageUrl) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$http$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["sendError"])(res, 502, 'Media provider returned no image');
        ...
        if (type === 'podcast') {
            ...
            if (!r.ok) {
                ...
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$http$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["sendError"])(res, 500, 'TTS failed: ' + err);
            }
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$http$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["sendError"])(res, 400, 'Unsupported media type');
    } catch (err) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["error"])('media error', {
            cid,
            message: err?.message || String(err)
        });
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$http$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["sendError"])(res, 500, err?.message || 'unknown error');
    }
}
__turbopack_async_result__();
} catch(e) { __turbopack_async_result__(e); } }, false);}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0ch8wjh._.js.map