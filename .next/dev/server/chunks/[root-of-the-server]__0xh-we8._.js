...
"[project]/pages/api/profile.ts [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const DB_PATH = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'data', 'app.db');
async function handler(req, res) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["info"])('profile api request', {
        cid,
        method: req.method,
    ...
    try {
        ...
        if (req.method === 'GET') {
            ...
            db.close();
            if (!row) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$http$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["sendError"])(res, 404, 'User not found');
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["info"])('profile fetched', {
                cid,
                userId
            });
        ...
        if (req.method === 'POST') {
            const rl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$rateLimit$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["rateLimit"])(String(req.socket.remoteAddress || 'ip') + ':profile', 10, 60_000);
            ...
            const parsed = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$validate$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["profileSchema"].safeParse(input);
            ...
            db.close();
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["info"])('profile updated', {
                cid,
                userId
            });
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$http$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["sendOk"])(res, {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["error"])('profile api error', {
            cid,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0xh-we8._.js.map